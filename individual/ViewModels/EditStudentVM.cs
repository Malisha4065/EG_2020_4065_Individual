...
{
    public partial class EditStudentVM : ObservableObject, IRecipient<EditPersonMessenger>
    {
        [ObservableProperty]
        public int id;
        [ObservableProperty]
        ...
        public EditStudentVM()
        {
            ...
            WeakReferenceMessenger.Default.Register<EditPersonMessenger>(this);
        ...
        public void SubmitButton()
        {
            ...
            else
            {
                ...
                //-------------------------------------
                Student.GPA = CalcGPA();
                WeakReferenceMessenger.Default.Send(new SendBackEditPersonMessenger(Student));
                CloseAction();
            }
        }

        public void Receive(EditPersonMessenger message)
        {
            ...
            City = Student.City;
            FormPhoto = Student.Photo;
            Ee3301 = Student.Modules[0].Grade;
            Ee3302 = Student.Modules[1].Grade;
            Ee3203 = Student.Modules[2].Grade;
            Ee3305 = Student.Modules[3].Grade;
            Ee3206 = Student.Modules[4].Grade;
            Ee3151 = Student.Modules[5].Grade;
            Is3302 = Student.Modules[6].Grade;
        }
